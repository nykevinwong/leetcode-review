...
public class CreatePage
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String indexTemplate = readWholeText("index.template");
        String tocItemTemplate = readWholeText("toc-item.template");
        String codeTemplate = readWholeText("code.template");
        ...
        try
        {
            ...
            for (File file : filesList) {
                if (file.isFile()) {
                    ...
                    String divId = codeId;
                    String checkboxId = "checkbox_"+ count;
